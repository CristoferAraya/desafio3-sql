...
CREATE DATABASE "desafio3-cristofer-araya-234";

    -- Ingresando a la base de datos
\c "desafio3-cristofer-araya-234"
...
VALUES
('josefa@email.com', 'Josefa', 'Perez', 'administrador'),
('pablo@email.com', 'Pablo', 'Quezada', 'usuario'),
('miguel@email.com', 'Miguel', 'Vasquez', 'usuario'),
('javier@email.com', 'Javier', 'Uribe', 'usuario'),
('Carlos@email.com', 'Carlos', 'herrera', 'usuario');
...
VALUES
('Titulo del post 1', 'Contenido del post 1', '2023-04-12 13:15:00', '2023-04-13 23:45:00', true, 1),
('Titulo del post 2', 'Contenido del post 2', '2023-04-30 00:25:00', '2023-04-30 06:32:00', false, 1),
('Titulo del post 3', 'Contenido del post 3', '2023-04-21 07:03:00', '2023-04-22 13:31:00', false, 2),
('Titulo del post 4', 'Contenido del post 4', '2023-04-20 20:41:00', '2023-04-22 15:00:00', true, 3),
('Titulo del post 5', 'Contenido del post 5', '2023-04-19 19:30:00', '2023-04-21 19:48:00', false, null);
